    ...
    <div class="bg-light">
        <div class="container py-5">
            <div class="row h-100 align-items-center py-5">
                ...
                <div class="col-lg-6 px-5 mx-auto order-1 order-lg-2"><img style="width: 50%" src="{{asset('/images/logo.png')}}" alt="eshopLogo" class="mb-4 mb-lg-0 center img-fluid"/></div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 order-2 order-lg-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="fa fa-bar-chart fa-2x mb-3 text-primary bi bi-people-fill" viewBox="0 0 16 16">
                        <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/>
                    </svg>
                    <h2 class="font-weight-light">Kto sme?</h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="fa fa-bar-chart fa-2x mb-3 text-primary bi bi-question-circle" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                        <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
                    </svg>
                    <h2 class="font-weight-light">Preco my?</h2>
                    <p class="font-italic text-muted mb-4">Vdaka rozsiahlym znalostiam zvukovej techniky Vam vieme poradit a najst spravny produkt prave pre Vas. V pripade akychkolvek otazok nas nevahajte kontaktovat, ci uz telefonicky, e-mailom alebo sa zastavte osobne v nasom sidle.</p>
