...
<div class="d-flex flex-row comment-row p-0 pb-1 pt-3">
    ...
    <div class="comment-text w-100 pe-2">
            ...
            <span class="date">
                <div class="d-flex ratings mr-2">
                    ...
                    @if (!is_null($loggedUser))
                        @if ($loggedUser->ownsReview($review) || $loggedUser->hasRole(['reviewManager']))
                        <a class="confirmDeleteReviewClass reviewAction" data-id="{{$review->id_user}}" data-bs-toggle="modal" data-bs-target="#confirmDeleteReview">
                            <svg style="margin-top: 3px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="ms-3 bi bi-trash3" viewBox="0 0 16 16">
                        ...
                        <a class="editReviewClass reviewAction" data-rating="{{$review->rating}}" data-product-id="{{$review->id_product}}" data-author-id="{{$review->id_user}}">
                            <svg style="margin-top: 3px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="ms-1 bi bi-pencil-square" viewBox="0 0 16 16">
