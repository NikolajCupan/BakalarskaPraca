...
<ul class="sticky-lg-top stickyOffset list-group">
    ...
    <a href="/admin/product/warehouse" class="@if (isset($activeCategory) && $activeCategory == 'warehouse') list-group-item-dark @endif
    ...
    <a href="/admin/product/shop" class="@if (isset($activeCategory) && $activeCategory == 'shop') list-group-item-dark @endif
                                         list-group-item list-group-item-action list-group-item d-flex justify-content-between align-items-center">
