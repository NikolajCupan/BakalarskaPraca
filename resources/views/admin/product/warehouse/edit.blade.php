            ...
            <div class="col-md-12 col-lg-9">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <form method="POST" action="/admin/product/warehouse/destroy">
                        ...
                        <button type="submit" class="justify-content-end btn btn-danger btn ms-2">Zmazat</button>
                    </form>
                    @endif
                </div>
                ...
                @if ($warehouseProduct[0]->isActive())
                    <h4 class="mt-3 activeProduct">Produkt je aktivny</h4>
                @else
                    <h4 class="mt-3 inactiveProduct">Produkt je neaktivny</h4>
                @endif
                ...
                <form method="POST" action="/admin/product/warehouse/update">
                    ...
                    <div class="mt-3 col-md-6 mb-4">
                        <div class="form-group form-floating">
                            <input type="text" class="form-control" name="product" id="product" placeholder="product" value="{{old('product') ?? $warehouseProduct[0]->product}}">
